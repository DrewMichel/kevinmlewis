...
namespace Lecture13Database {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(int ContactId, string Name, string Company) {
...
namespace Lecture13Database.DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([ContactId] = @Original_ContactId))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([ContactId], [Name], [Company]) VALUES (@ContactId, @N" +
                "ame, @Company);\r\nSELECT ContactId, Name, Company FROM [Table] WHERE (ContactId =" +
                " @ContactId)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [ContactId] = @ContactId, [Name] = @Name, [Company] = @C" +
                "ompany WHERE (([ContactId] = @Original_ContactId));\r\nSELECT ContactId, Name, Com" +
                "pany FROM [Table] WHERE (ContactId = @ContactId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Lecture13Database.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContactId, Name, Company FROM dbo.[Table]";
        ...
        public virtual int Insert(int ContactId, string Name, string Company) {
        ...
        public virtual int Update(int ContactId, string Name, string Company, int Original_ContactId) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Company, int Original_ContactId) {
            return this.Update(Original_ContactId, Name, Company, Original_ContactId);
        }
    }
